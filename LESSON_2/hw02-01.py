...
myvacancy='java'
#vacancy = input('Введите название нужной вакансии: ').strip()
                ...
                # опредляем шаблон ЗП. это диапазон типа от 140 000 руб.
                    ...
                    # опредляем шаблон ЗП. это диапазон типа от 140 000 руб.
                        ...
                        if (match):
                            ...
                            salary_min = 'По договорённости'
                            salary_max = 'По договорённости'
                            salary_currency = 'По договорённости'
            else:
                salary_min = 'По договорённости'
                salary_max = 'По договорённости'
                salary_currency = 'По договорённости'
...
while True:
    ...
    if not vacancy_block:
        ...
        next_page_url='' #
        break;
    vacancy_list = vacancy_block.find_all('div',{'class':'_3zucV _1fMKr undefined _3tcTB _3SGgo'})
